...
import com.kunminx.linkagelistview.databinding.FragmentMuchPrimaryItemBinding;
...
public class MuchPrimaryItemSampleFragment extends Fragment {
  ...
  private FragmentMuchPrimaryItemBinding mBinding;

  @Nullable
  @Override
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    View view = inflater.inflate(R.layout.fragment_much_primary_item, container, false);
    mBinding = FragmentMuchPrimaryItemBinding.bind(view);
