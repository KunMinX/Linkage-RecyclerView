 ...
 */
public class FindGoodPhoneGroupedItem extends BaseGroupedItem<FindGoodPhoneGroupedItem.ItemInfo> {

    public FindGoodPhoneGroupedItem(boolean isHeader, String header) {
        super(isHeader, header);
    }

    public FindGoodPhoneGroupedItem(ItemInfo item) {
        super(item);
    }
